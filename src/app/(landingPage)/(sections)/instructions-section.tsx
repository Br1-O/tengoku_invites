"use client"
import AnimateOnScroll from "@/src/components/animateOnScroll/animateOnScroll";
import DownArrow from "@/src/components/arrow/downArrow";
import IconTitleDescriptionCard from "@/src/components/cards/iconTitleDescriptionCard";
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-14 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-6 xl:grid-cols-3 xl:grid-rows-4 gap-4 w-11/12 md:w-3/4 min-h-[50vh]">
              <AnimateOnScroll
                ...
                delay = {0.1}
                ease = "power2.out"
                className="md:col-start-1 md:row-start-1 relative flex flex-col justify-center items-center p-2 rounded-xl"
              >
              ...
              <AnimateOnScroll
                ...
                delay = {0.25}
                ease = "power2.out"
                className="md:col-start-1 md:row-start-2 relative flex flex-col justify-center items-center p-2 rounded-xl"
              >
                <IconTitleDescriptionCard 
                  icon={TicketIcon} 
                  title="Entrada" 
              ...
              <AnimateOnScroll
                animationName = "enterFromUp"
                duration = {0.5}
                delay = {0.5}
                ease = "power2.out"
                className="md:row-span-2 md:col-start-2 md:row-start-1 relative flex flex-col justify-center items-center p-2 rounded-xl"
              >
                <IconTitleDescriptionCard 
              ...
              <AnimateOnScroll
                ...
                delay = {0.75}
                ease = "power2.out"
                className="md:row-span-2 md:row-start-3 relative flex flex-col justify-center items-center p-2 rounded-xl"
              >
                <IconTitleDescriptionCard 
