  ...
  return (
    <div className="flex items-center justify-center p-8 min-h-[100vh] overlay-shadow">
      <div className="bg-gray-900 p-5 rounded-lg shadow-lg">
        ...
        <p className="text-lg mb-4 text-white">Al registrarte para participar en el evento &quot;Tengoku Game&quot;, aceptas los siguientes términos de exoneración de responsabilidad:</p>
