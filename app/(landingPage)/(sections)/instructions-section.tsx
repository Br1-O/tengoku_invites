      ...
      <div className="px-4 w-full flex flex-col justify-center items-center">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 md:grid-rows-6 xl:grid-cols-3 xl:grid-rows-4 gap-4 w-11/12 md:w-3/4 min-h-[50vh]">
            ...
            <AnimateOnScroll
              animationName = {screenSize === "sm" ? "enterFromRight" : "enterFromUp"}
              duration = {0.5}
              delay = {0.5}
              ease = "power2.out"
            ...
            <AnimateOnScroll
              animationName = {screenSize === "sm" ? "enterFromRight" : "enterFromDown"}
              duration = {0.5}
              delay = {1.25}
              ease = "power2.out"
              className="md:row-span-2 md:row-start-3 relative flex flex-col justify-center items-center p-2 rounded-xl"
            ...
            <AnimateOnScroll
              animationName = {screenSize === "lg" ? "enterFromRight" : "enterFromLeft"}
              duration = {0.5}
              delay = {1.5}
              ease = "power2.out"
